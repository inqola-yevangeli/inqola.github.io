...
?>
<body>
    <form action="check-add-announcement.php" method="post" enctypr="multipart/form-data" autocomplete="off">
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Post Announcements</h3>
                    ...
                    <?php          
                        ...
                        if($result-> num_rows > 0){
                            echo "<select name='select-branch' class='input' style='width: 100%; margin-top:10px; margin-bottom:10px; border-radius:5px;'>";
                    ...
                    <textarea name="messagee" type="text" id="textarea" rows="4" cols="50" class="table bg-white rounded shadow-sm  table-hover"  
                    placeholder="Message" Required></textarea>

                    <button type="submit" class="table bg-white rounded shadow-sm  table-hover"  
                    style="height: 40px; border: none;">Submit</button>
                    </div>
                </div>
            </div>
        </div>
