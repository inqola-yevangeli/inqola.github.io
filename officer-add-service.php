...
<head>
    ...
    <title>Officer Add Service</title>
    <style>
        .input{
            height: 40px; 
            width: 49.7%; 
...
<body>
    <form action="officer-create-service.php" method="POST" enctype="multipart/form-data" autocomplete="off">
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Add Service</h3>
                    ...
                    <select name="select-branch" id="select" class="input">
                        <option value="select-branch">Select Branch</option>
                        <option value="select-branch">Branch 1</option>
                        <option value="select-branch">Branch 2</option>
                    </select>
                    <input type="text" class="input" name="date" placeholder="Date"></input>
                    <input type="text" class="input" name="time" placeholder="Time"></input>
                    <input type="text" class="input" name="link" placeholder="Link"></input>

                    <textarea type="text" name="textarea" id="textarea" rows="4" cols="50" class="table bg-white rounded shadow-sm  table-hover"  
                    placeholder="Service Description" style="margin-bottom:0px; margin-top:10px;"></textarea>

                    <button type="submit" class="input" style="width: 100%; margin-bottom: 10px;">Submit</button>
                    </div>
                </div>
            </div>
        </div>
