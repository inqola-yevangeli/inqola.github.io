...
<head>
    ...
    <title>Officer View Service</title>
    <style>
        .input{
            height: 40px; 
            width: 48%; 
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    ...
                    <select id="select" class="input" style="width:98%;">
                    ...
                    <label class="input">Branch Name : Branch 101</lebel><br>
                    <label class="input">Date : 01/06/2022</lebel><br>
                    <label class="input">Time : 16:35</lebel><br>
                    <label class="input">Link : www.msteams.com/chbfhcfbbcbdbchbdch</lebel><br>
                    <label class="input">Service Description : Opening prayer</lebel><br>

                    <button type="submit" style="margin-bottom: 10px;" class="input" onclick="location='#'">Join Now</button>
                    <button type="submit" style="margin-bottom: 10px;" class="input">Delete</button>
                    </div>
                    <!-- ------------------------------------------------------------------------------------------------------------ -->
                    <div class="content" style="border: 1px solid; width: 98%; margin-left: 10px; border-radius: 10px; margin-top: 5px;">
                        <input type="text" class="input" placeholder="Date" disabled></input>
                        <input type="text" class="input" placeholder="Time" disabled></input>
                        <input type="text" class="input" placeholder="Link" style="width:98%;" disabled></input>

                        <button type="submit" class="table bg-white rounded shadow-sm  table-hover"  
                        style="width: 98%; margin-left: 10px; height: 40px; border: none; border-radius: 10px; margin-top: 10px;">Delete</button>
                    </div>
                </div>
            </div>
        </div>
