...
?>
<body>
<form action="check-create-user.php" method="post" enctype="multipart/form-data" autocomplete="off">
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Create User</h3>
                    ...
                    <?php } ?>
                    <!-- ------------------------------------------------------------------------------------- -->
                    <input type="text" name="name" class="input" placeholder="Name" Required></input>
                    <input type="text" name="surname" class="input" placeholder="Surname" Required></input>
                    <input type="number" name="phone" class="input" placeholder="Phone Number e.g 060010111" Required></input>
                    <input type="email" name="email" class="input" placeholder="Email Address" Required></input>
                    ...
                    <?php          
                        ...
                        if($result-> num_rows > 0){
                            echo "<select name='select-status' class='input'>";
                                echo "<option value='Select'>Select Membership Status</option>";
                    ...
                    <?php          
                        ...
                        if($result-> num_rows > 0){
                            echo "<select name='select-occupation' class='input' style='margin-bottom: 10px;'>";
                                echo "<option value='Select'>Select Occupation</option>";
                            while($row = $result-> fetch_assoc()){
                    ...
                    <input type="text" class="input" name="address" placeholder="Address" Required></input>
                    <input type="text" class="input" name="country" placeholder="Country" Required></input>
                    <input type="text" class="input" name="province" placeholder="Province" Required></input>
                    <input type="text" class="input" name="city" placeholder="City" Required></input>
                    <input type="number" class="input" name="zipcode" style="margin-bottom: 10px;" placeholder="Zip Code" Required></input>
                    </div>
                    <!-- ----------------------------------------------------------------------------------------------- -->
                    <div class="content" style="border: 1px solid; width: 98%; margin-left: 10px; border-radius: 10px; margin-top: 5px;">
                    <h4 style="text-align: center;">Password Information</h4>
                    <input type="password" class="input" name="password" placeholder="Password" Required></input>
                    <input type="password" class="input" name="confirm" placeholder="Confirm Password" Required></input>
                    <button type="submit" class="btn">Submit</button>
                    <!-- onclick="location='officer-update-branch.php'" -->
                    </div>
                </div>
            </div>
        </div>
