        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    ...
                    <input type="text" class="input" placeholder="Address"></input>
                    ...
                    <select id="select" class="input">
                        ...
                        <option value="select">Province 1</option>
                        <option value="select">Province 2</option>
                    </select>
                    <select id="select" class="input">
                    ...
                    <input type="number" class="input" placeholder="Zip Code"></input>
                    <select id="select" class="input" style="width: 100%;">
                        <option value="select">Select Leader</option>
                        <option value="select">City 1</option>
                        <option value="select">City 2</option>
                    </select>
                    <button type="submit" class="btn" onclick="location='officer-view-branch.php'">Cancel</button>
                    <button type="submit" class="btn" onclick="location='officer-view-branch.php'">Submit</button>
                    </div>
                </div>
            </div>
        </div>
