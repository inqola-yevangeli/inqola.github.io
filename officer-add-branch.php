...
<head>
    ...
    <title>Officer Add Branch</title>
    <style>
        .input{
            height: 40px; 
            width: 49.75%; 
...
<body>
    <form action="officer-add-branch.php" method="post" enctypr="multipart/form-data" autocomplete="off">
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Add Branch</h3>
                    ...
                    <?php } ?>
                    <input type="text" name="branchName" class="input" placeholder="Branch Name" Required></input>
                    <input type="text" name="address" class="input" placeholder="Address" Required></input>
                    <select id="select" name="country" class="input">
                        <option value="select">Select Country</option>
                        <option value="select">South Africa</option>
                        <option value="select">Other</option>
                    </select>
                    <select id="select" name="province" class="input">
                        <option value="select">Select Province</option>
                        <option value="select">KwaZulu Natal</option>
                        <option value="select">Limpopo</option>
                        <option value="select">Gauteng</option>
                        <option value="select">Mpumalang</option>
                        <option value="select">Western Cape</option>
                        <option value="select">Eastern Cape</option>
                        <option value="select">Northern Cape</option>
                        <option value="select">North West</option>
                        <option value="select">Free State</option>
                        <option value="select">Other</option>
                        
                    </select>
                    <select id="select" name="city" class="input">
                        <option value="select">Select City</option>
                        <option value="select">Durban</option>
                        <option value="select">Johannesburg</option>
                        <option value="select">Cape Town</option>
                        <option value="select">Gqeberha</option>
                        <option value="select">Pretoria</option>
                        <option value="select">Bloemfontein</option>
                        <option value="select">East London</option>
                        <option value="select">Soweto</option>
                        <option value="select">Mossel Bay</option>
                        <option value="select">Vereeniging</option>
                        <option value="select">Polokwane</option>
                        <option value="select">Richards Bay</option>
                        <option value="select">Pietermaritzburg</option>
                        <option value="select">Ulundi</option>
                    </select>
                    <input type="number" name="zipCode" class="input" placeholder="Zip Code" Required></input>

                    <button type="submit" name="submit" class="btn">Submit</button>
                    <!-- onclick="location='officer-add-branch.php'" -->
    </div>
                </div>
            </div>
        </div>
