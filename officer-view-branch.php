...
<head>
    ...
    <title>Officer View Branch</title>
    <style>
        .input{
            height: 35px; 
            width: 49.7%; 
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    ...
                    <label class="input">Country : South Africa</lebel><br>
                    <label class="input">Province : KwaZulu Natal</lebel><br>
                    <label class="input">Address : 19768 Mangosuthu Highway, Durban (City), 4001 (Zip Code)</lebel><br>
                    <label class="input">Branch Leader : Mr JJ Msane</lebel><br>

                    <button type="submit" class="input" onclick="location='officer-update-branch.php'">Update</button>
